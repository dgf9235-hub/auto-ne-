    ...
    def dispatch_for_study_unit(self):
        ...
        for folder_name in os.listdir(folder_path2):
            ...
            for filename in os.listdir(folder_path3):
                ...
                print(cluster_harmer_dataframe.head(50))
                print(cluster_mw_impact)
                ...
                print(resource_dataframe.head(60))
                #print(resource_dataframe[' MaxGenImp'].abs().sum())


                #matching_row['Helper Impact']= self.create_Balanced_Helper_dispatch(resource_dataframe,cluster_mw)
                ...
                print(100*(cluster_mw_impact+abs(helper_mw))/rate)
